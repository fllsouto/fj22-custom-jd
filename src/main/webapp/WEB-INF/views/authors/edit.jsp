 		...
 		<div class="col main pt-5 mt-3">
	        ...
	        <form  action="<c:url value='/authors/update' />" method="post">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" name="name" id="authorName" value="${ author.name }" placeholder="João da Silva">
			  ...
			  <div class="form-group">
			    ...
			    <textarea class="form-control" name="description" id="authorDescription" rows="3" placeholder="João da Silva é desenvolvedor backend..."> ${ author.description }</textarea>
